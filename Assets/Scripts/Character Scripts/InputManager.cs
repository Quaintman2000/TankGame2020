...
public class InputManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (playerNumber == 1)
        {
            GameManager.Instance.playerOneData = data;
        }
        else if (playerNumber == 2)
        {
            GameManager.Instance.playerTwoData = data;
        }
        else
        {
            Debug.LogError("[input manager] inncorrect player num set");
        }
    }
